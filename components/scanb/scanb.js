              ...
              <div className="text-center scan-bmoblatp clearfix">
                ...
                <div className="image-subheading row align-items-center justify-content-center w-100 m-0">
                  <div className="col-12 col-md-7 p-0">
                    <Image width={'805'} height={'489'} src={data?.content?.scanb_mid_banner_media_id?.file_path} alt="Advanced Retail BI for data-driven decisions that win" style={{ paddingTop: '15px', width: '100%', height: 'auto' }} />
                  </div>
