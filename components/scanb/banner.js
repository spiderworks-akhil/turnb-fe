...
const ScanbBanner = ({ data }) => {
  ...
  return (
    <>
      <div
        className='d-block text-center mr-topinnerpagescan mt-0   '
            ...
            <div className='modal-dialog modal-dialog-centered'>
              <div className='modal-content'>
                ...
                <div className='modal-body p-0'>
                  ...
                  >
                    <source
                      src={data?.content?.scanb_vedio_media_id?.file_path}
                      type='video/mp4'
                    />
                    ...
                    >
                      ...
                      <div>
                        <h5 className='text-white'>
                          Thank you for your interest in ScanB. <br />
                          <span style={{ fontSize: '16px', fontWeight: 600 }}>
                            To view or download the brochure, please complete
                      ...
                      <div className='col-12'>
                        <button
                          disabled={loading}
                          type='submit'
                          className='btn btn-brand btnsubmt'
                        >
                          {loading ? (
