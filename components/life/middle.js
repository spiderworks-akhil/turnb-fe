        ...
        <div className="row ">
          <div className="col-lg-6 col-md-6 col-12 ">
            <div className="img-lifet mt-lg-4 mt-md-4 mt-3" data-aos="fade-up">
              <div className="imginner-lfe mb-lg-4 mb-md-4 mb-3 " >
                ...
                <Slider {...options}>
                  {
                    data?.other_sections?.Life_at_turnb_slider?.slider_1?.photos?.map((obj, index) => (
          ...
          <div className="col-lg-6 col-md-6 col-12">
            <div className="cont-lifpad" data-aos="fade-up">
              ...
              <Slider {...options}>
                {
                  data?.other_sections?.Life_at_turnb_slider?.slider_2?.photos?.map((obj, index) => (
                    <div key={index} className="item">
                      <Image
                        src={obj?.url?.file_path}
                        alt={obj?.alt_text}
              ...
              <div dangerouslySetInnerHTML={{ __html: data?.content?.life_at_turnb_description_2 }} />
              {/* 
